...
class users{
	...
	*/
	...
	//Validate gender: male = 1, female = 0
	...
	*contains: name, password, email, date of birth, gender and weight
	...
	*/
	function upload_picture($id, $image){
		...
		if($image!=null){
			...
			$imagepath = "323world/images/users/".$id . '.' .end($temp);
			$file = $image;
	...
	*/
	function send_recovery_id($data){
		...
		"Enter this  recovery id on your mobile app to reset your password: ".$link_id;
